...
# Remove modifier and parent from Demolishor mesh
demo_mesh.modifiers.clear()
demo_mesh.parent = None
bpy.data.objects.remove(demo_arm, do_unlink=True)
...
out_img = Path("C:/Users/lenovo/.gemini/antigravity/brain/61450739-b3fd-40a5-b308-e6e69fbc5127/blender_side_by_side_fixed.png")
bpy.context.scene.render.filepath = str(out_img)
bpy.ops.render.render(write_still=True)
print(f"[✓] Rendered side-by-side fixed to {out_img}")
