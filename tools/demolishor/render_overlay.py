...
# Camera position: front view (looking at Y=5.2 from Z=15)
cam_obj.location = (0, -18, 5.2)
...
out_img = Path("C:/Users/lenovo/.gemini/antigravity/brain/61450739-b3fd-40a5-b308-e6e69fbc5127/blender_overlay_view.png")
bpy.context.scene.render.filepath = str(out_img)
bpy.ops.render.render(write_still=True)
print(f"[✓] Rendered overlay view to {out_img}")
